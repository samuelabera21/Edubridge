        ...
        <div className="space-y-5 text-gray-900">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-1 border-b border-gray-200">
                <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">Official student notices, examination instructions, and school activity announcements.</p>
                </div>
                <Button 
                    onClick={() => setIsModalOpen(true)} 
                    leftIcon={<Plus className="w-4 h-4" />} 
                    className="bg-blue-700 hover:bg-blue-800 text-white text-xs h-9 px-4 font-medium shadow-sm"
                >
                    New Broadcast
                </Button>
            </div>
            ...
            <div className="relative">
                ...
                <input
                    ...
                    placeholder="Search student broadcasts..."
                    className="w-full pl-9 pr-3 py-2 text-xs bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-700"
                />
            </div>
            ...
            <div className="space-y-3">
                {filteredAnnouncements.length === 0 ? (
                    <div className="bg-white border border-dashed border-gray-300 rounded-xl p-10 text-center text-gray-500">
                        ...
                        <p className="text-sm font-semibold text-gray-800">No student broadcasts found</p>
                    ...
                    filteredAnnouncements.map((item) => (
                        ...
                        >
                            ...
                            {/* Content */}
                            <div className="text-xs text-gray-700 leading-relaxed bg-blue-50/20 p-3 rounded-lg border border-blue-100">
                        ...
                        <form onSubmit={handleCreateAnnouncement} className="space-y-3.5">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full border border-gray-300 rounded-lg p-2 text-xs focus:ring-1 focus:ring-blue-700 focus:outline-none"
                                />
                            </div>
                            ...
                            <div className="flex justify-end space-x-2 pt-3 border-t border-gray-100">
                                ...
                                <Button type="submit" isLoading={submitting} className="bg-blue-700 hover:bg-blue-800 text-white text-xs h-8 px-4">
                                    Publish Notice
                                </Button>
                            </div>
                        </form>
