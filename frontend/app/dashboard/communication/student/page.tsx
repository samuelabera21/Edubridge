...
export default function StudentCommunicationPage() {
    ...
    if (loading) return <LoadingState message="Loading student broadcasts..." />;
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-xs overflow-hidden">
                {paginatedAnnouncements.length === 0 ? (
                    <div className="p-12 text-center text-gray-500 space-y-2">
                        <GraduationCap className="w-8 h-8 mx-auto text-gray-300" />
                        <p className="font-semibold text-gray-800 text-sm">No student broadcasts found</p>
                        <p className="text-xs text-gray-400">Announcements targeted to students will appear here.</p>
                    </div>
                ) : (
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-lg w-full p-5 space-y-4 border border-gray-100">
                        <div className="flex justify-between items-center border-b border-gray-100 pb-3">
                            <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
                                ...
                                {editingId ? "Edit Student Notice" : "Post Student Notice"}
                            </h3>
