...
import { AlertOctagon, Plus, Filter } from "lucide-react";
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    <h1 className="text-xl font-bold text-gray-900 flex items-center">
                        <AlertOctagon className="w-6 h-6 mr-2 text-blue-500" />
                        Facility Issues
                    </h1>
                    <p className="text-sm text-gray-500 mt-1">Report and track maintenance, security, and facility incidents.</p>
                </div>
                {hasCreatePermission && (
            ...
            {issues.length === 0 ? (
                <EmptyState 
                    ...
                    message="There are no facility issues currently reported." 
                />
            ) : (
                <Card>
