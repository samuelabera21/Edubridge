...
export default function StudentAttendancePage() {
    ...
    const loadData = async () => {
        try {
            ...
            // 2. Fetch Enrollments to serve as the base for attendance selection
        ...
        return (
            <div className="space-y-6">
                ...
                <EmptyState 
                    ...
                    message="You must have an active academic year to manage attendance." 
                />
            </div>
        );
    }
        ...
        <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Track and manage attendance records for <span className="font-semibold text-blue-500">{activeYear.name}</span>
                    </p>
                </div>
            </div>
            ...
            {enrollments.length === 0 ? (
                <EmptyState 
                    ...
                    message={`There are no students enrolled for the ${activeYear.name} academic year to track attendance.`} 
                />
            ) : (
                <Card>
                    <CardHeader className="bg-gray-50/50 flex flex-row items-center justify-between py-4">
                        ...
                        <div className="flex space-x-2">
                            <Button variant="ghost" size="sm" leftIcon={<Filter className="w-4 h-4" />}>Filter Grade</Button>
                        </div>
                    </CardHeader>
