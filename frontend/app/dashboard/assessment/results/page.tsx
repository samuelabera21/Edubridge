...
export default function StudentResultsPage() {
    ...
    const loadData = async () => {
        try {
            ...
            // 2. Fetch Enrollments to serve as the base for selecting a student's results
        ...
        return (
            <div className="space-y-6">
                ...
                <EmptyState 
                    ...
                    message="You must have an active academic year to view results." 
                />
            </div>
        );
    }
        ...
        <div className="space-y-6">
            ...
            {enrollments.length === 0 ? (
                <EmptyState 
                    ...
                    message={`There are no students enrolled for the ${activeYear.name} academic year to view results.`} 
                />
            ) : (
                <Card>
                                    ...
                                    {enrollments.map((enrollment) => (
                                        <tr key={enrollment.id} className="hover:bg-gray-50/50 transition-colors">
                                            ...
                                            <td className="px-6 py-4 text-right space-x-2">
                                                <Button variant="ghost" size="sm">View Report Card</Button>
                                            </td>
                                        </tr>
                                    ))}
                                </tbody>
