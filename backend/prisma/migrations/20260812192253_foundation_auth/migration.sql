-- CreateEnum
CREATE TYPE "OrganizationUnitType" AS ENUM ('FEDERAL', 'REGION', 'ZONE', 'WOREDA', 'SCHOOL');
...
-- CreateIndex
CREATE UNIQUE INDEX "RoleAssignment_userId_roleId_scopeId_key" ON "RoleAssignment"("userId", "roleId", "scopeId");
...
-- AddForeignKey
ALTER TABLE "RoleAssignment" ADD CONSTRAINT "RoleAssignment_scopeId_fkey" FOREIGN KEY ("scopeId") REFERENCES "OrganizationUnit"("id") ON DELETE CASCADE ON UPDATE CASCADE;
